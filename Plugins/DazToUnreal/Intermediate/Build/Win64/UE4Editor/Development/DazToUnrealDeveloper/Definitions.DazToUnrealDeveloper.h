#undef DAZTOUNREALDEVELOPER_API
...
#define UE_PROJECT_NAME ProjectK
#define UE_TARGET_NAME ProjectKEditor
...
#define DAZTOUNREALRUNTIME_API DLLIMPORT
#define DAZTOUNREALDEVELOPER_API DLLEXPORT
